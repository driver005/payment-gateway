...
type PaymentLink struct {
	...
	AfterCompletion           *options.PaymentLinksResourceAfterCompletion           `json:"after_completion,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	ConsentCollection         *options.PaymentLinksResourceConsentCollection         `json:"consent_collection,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	Currency                  string                                                 `json:"currency,omitempty"`
	CustomText                *options.PaymentLinksResourceCustomText                `json:"custom_text,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	PaymentIntentData         *options.PaymentLinksResourcePaymentIntentData         `json:"payment_intent_data,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	ShippingAddressCollection *options.PaymentLinksResourceShippingAddressCollection `json:"shipping_address_collection,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	SubscriptionData          *options.PaymentLinksResourceSubscriptionData          `json:"subscription_data,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
