...
type ShippingRateDeliveryEstimate struct {
	...
	Maximum *ShippingRateDeliveryEstimateBound `json:"maximum,omitempty" database:"foreignKey:id"`
	Minimum *ShippingRateDeliveryEstimateBound `json:"minimum,omitempty" database:"foreignKey:id"`
}
...
type ShippingRateFixedAmount struct {
	...
	CurrencyOptions *ShippingRateCurrencyOption `json:"currency_options,omitempty" database:"foreignKey:id"`
}
...
type ShippingRate struct {
	...
	DeliveryEstimate *ShippingRateDeliveryEstimate `json:"delivery_estimate,omitempty" database:"foreignKey:id"`
	// The name of the shipping rate, meant to be displayable to the customer. This will appear on CheckoutSessions.
	DisplayName string                   `json:"display_name,omitempty"`
	FixedAmount *ShippingRateFixedAmount `json:"fixed_amount,omitempty" database:"foreignKey:id"`
	TaxBehavior TaxBehavior              `json:"tax_behavior,omitempty"`
	TaxCode     *tax.TaxCode             `json:"tax_code,omitempty" database:"foreignKey:id"`
