...
func (s *Handler) Retrive(ctx context.Context, Id uuid.UUID) (*Card, error) {
	var m Card
...
func (s *Handler) List(ctx context.Context, Offset int, Size int) ([]Card, *int64, error) {
	var m = make([]Card, 0)
...
func (s *Handler) Create(ctx context.Context, m *Card) (*Card, error) {
...
func (s *Handler) Update(ctx context.Context, m *Card) (*Card, error) {
	var o *Card
...
func (r *Handler) Upsert(ctx context.Context, m *Card) (*Card, error) {
...
func (s *Handler) Delete(ctx context.Context, Id uuid.UUID) error {
	if err := s.r.Manager(ctx).Where("id = ?", Id).Delete(&Card{}).Error; err != nil {
		return err
	}
