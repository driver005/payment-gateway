...
func (h *Handler) SetRoutes(r fiber.Router) {
	//TODO: Add CashBalance
	r.Get("/customers/:id/cash_balance", h.RouteGet)
	r.Post("/customers/:id/cash_balance", h.RouteUpdate)
	r.Get("/customers/:id/cash_balance_transactions/:id", h.RouteGet)
