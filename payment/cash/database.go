...
func (s *Handler) Retrive(ctx context.Context, Id uuid.UUID) (*CashBalance, error) {
	var m CashBalance
...
func (s *Handler) List(ctx context.Context, Offset int, Size int) ([]CashBalance, *int64, error) {
...
func (s *Handler) Create(ctx context.Context, m *CashBalance) (*CashBalance, error) {
...
func (s *Handler) Update(ctx context.Context, m *CashBalance) (*CashBalance, error) {
	var o *CashBalance
...
func (r *Handler) Upsert(ctx context.Context, m *CashBalance) (*CashBalance, error) {
...
func (s *Handler) Delete(ctx context.Context, Id uuid.UUID) error {
	if err := s.r.Manager(ctx).Where("id = ?", Id).Delete(&CashBalance{}).Error; err != nil {
		return err
	}
