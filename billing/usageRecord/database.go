...
func (s *Handler) Retrive(ctx context.Context, Id uuid.UUID) (*UsageRecord, error) {
	var m UsageRecord
...
func (s *Handler) List(ctx context.Context, Offset int, Size int) ([]UsageRecord, *int64, error) {
...
func (s *Handler) Create(ctx context.Context, m *UsageRecord) (*UsageRecord, error) {
...
func (s *Handler) Update(ctx context.Context, m *UsageRecord) (*UsageRecord, error) {
	var o *UsageRecord
...
func (r *Handler) Upsert(ctx context.Context, m *UsageRecord) (*UsageRecord, error) {
...
func (s *Handler) Delete(ctx context.Context, Id uuid.UUID) error {
	if err := s.r.Manager(ctx).Where("id = ?", Id).Delete(&UsageRecord{}).Error; err != nil {
		return err
	}
