...
func (s *Handler) Retrive(ctx context.Context, Id uuid.UUID) (*Invoiceitem, error) {
	var m Invoiceitem
...
func (s *Handler) List(ctx context.Context, Offset int, Size int) ([]Invoiceitem, *int64, error) {
...
func (s *Handler) Create(ctx context.Context, m *Invoiceitem) (*Invoiceitem, error) {
...
func (s *Handler) Update(ctx context.Context, m *Invoiceitem) (*Invoiceitem, error) {
	var o *Invoiceitem
...
func (r *Handler) Upsert(ctx context.Context, m *Invoiceitem) (*Invoiceitem, error) {
...
func (s *Handler) Delete(ctx context.Context, Id uuid.UUID) error {
	if err := s.r.Manager(ctx).Where("id = ?", Id).Delete(&Invoiceitem{}).Error; err != nil {
		return err
	}
