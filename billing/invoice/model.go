...
type Invoice struct {
	...
	AutomaticTax                 *tax.AutomaticTax                        `json:"automatic_tax,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	CustomerAddress              *address.Address                         `json:"customer_address,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	CustomerEmail                string                                   `json:"customer_email,omitempty"`
	CustomerName                 string                                   `json:"customer_name,omitempty"`
	CustomerPhone                string                                   `json:"customer_phone,omitempty"`
	CustomerShipping             *address.Shipping                        `json:"customer_shipping,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	FromInvoice                  *Invoice                                 `json:"from_invoice,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	HostedInvoiceUrl             string                                   `json:"hosted_invoice_url,omitempty"`
	InvoicePdf                   string                                   `json:"invoice_pdf,omitempty"`
	LastFinalizationError        *errors.ApiErrors                        `json:"last_finalization_error,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	PaymentSettings              *invoices.InvoicesPaymentSettings        `json:"payment_settings,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	StatusTransitions            *invoices.InvoicesStatusTransitions      `json:"status_transitions,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	ThresholdReason              *InvoiceThresholdReason                  `json:"threshold_reason,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	AccountTaxIds *tax.TaxId          `json:"account_tax_ids,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	DefaultPaymentMethod   *method.PaymentMethod      `json:"default_payment_method,omitempty" database:"foreignKey:default_payment_method_id" swaggertype:"primitive,string" format:"uuid"`
	...
	LatestRevision         *Invoice                   `json:"latest_revision,omitempty" database:"foreignKey:latest_revision_id" swaggertype:"primitive,string" format:"uuid"`
