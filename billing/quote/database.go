...
func (s *Handler) Retrive(ctx context.Context, Id uuid.UUID) (*Quote, error) {
	var m Quote
...
func (s *Handler) List(ctx context.Context, Offset int, Size int) ([]Quote, *int64, error) {
	var m = make([]Quote, 0)
...
func (s *Handler) Create(ctx context.Context, m *Quote) (*Quote, error) {
...
func (s *Handler) Update(ctx context.Context, m *Quote) (*Quote, error) {
	var o *Quote
...
func (r *Handler) Upsert(ctx context.Context, m *Quote) (*Quote, error) {
...
func (s *Handler) Delete(ctx context.Context, Id uuid.UUID) error {
	if err := s.r.Manager(ctx).Where("id = ?", Id).Delete(&Quote{}).Error; err != nil {
		return err
	}
