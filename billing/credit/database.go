...
func (s *Handler) Retrive(ctx context.Context, Id uuid.UUID) (*CreditNote, error) {
	var m CreditNote
...
func (s *Handler) List(ctx context.Context, Offset int, Size int) ([]CreditNote, *int64, error) {
...
func (s *Handler) Create(ctx context.Context, m *CreditNote) (*CreditNote, error) {
...
func (s *Handler) Update(ctx context.Context, m *CreditNote) (*CreditNote, error) {
	var o *CreditNote
...
func (r *Handler) Upsert(ctx context.Context, m *CreditNote) (*CreditNote, error) {
...
func (s *Handler) Delete(ctx context.Context, Id uuid.UUID) error {
	if err := s.r.Manager(ctx).Where("id = ?", Id).Delete(&CreditNote{}).Error; err != nil {
		return err
	}
