...
type CreditNoteLineItem struct {
	...
	DiscountAmounts []discount.Discount `json:"discount_amounts,omitempty" database:"foreignKey:id" swaggertype:"array,string" format:"uuid"`
	// ID of the invoice line item being credited
	InvoiceLineItem string `json:"invoice_line_item,omitempty"`
	// The number of units of product being credited.
	Quantity int `json:"quantity,omitempty"`
	// The amount of tax calculated per tax rate for this line item
	TaxAmounts []tax.TaxRate `json:"tax_amounts,omitempty" database:"foreignKey:id" swaggertype:"array,string" format:"uuid"`
...
type CreditNote struct {
	...
	Lines []CreditNoteLineItem `json:"lines,omitempty" database:"foreignKey:id" swaggertype:"array,string" format:"uuid"`
