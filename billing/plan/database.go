...
func (s *Handler) Retrive(ctx context.Context, Id uuid.UUID) (*Plan, error) {
	var m Plan
...
func (s *Handler) List(ctx context.Context, Offset int, Size int) ([]Plan, *int64, error) {
	var m = make([]Plan, 0)
...
func (s *Handler) Create(ctx context.Context, m *Plan) (*Plan, error) {
...
func (s *Handler) Update(ctx context.Context, m *Plan) (*Plan, error) {
	var o *Plan
...
func (r *Handler) Upsert(ctx context.Context, m *Plan) (*Plan, error) {
...
func (s *Handler) Delete(ctx context.Context, Id uuid.UUID) error {
	if err := s.r.Manager(ctx).Where("id = ?", Id).Delete(&Plan{}).Error; err != nil {
		return err
	}
