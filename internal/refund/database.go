...
func (s *Handler) Retrive(ctx context.Context, Id uuid.UUID) (*Refund, error) {
	var m Refund
...
func (s *Handler) List(ctx context.Context, Offset int, Size int) ([]Refund, *int64, error) {
	var m = make([]Refund, 0)
...
func (s *Handler) Create(ctx context.Context, m *Refund) (*Refund, error) {
...
func (s *Handler) Update(ctx context.Context, m *Refund) (*Refund, error) {
	var o *Refund
...
func (r *Handler) Upsert(ctx context.Context, m *Refund) (*Refund, error) {
...
func (s *Handler) Delete(ctx context.Context, Id uuid.UUID) error {
	if err := s.r.Manager(ctx).Where("id = ?", Id).Delete(&Refund{}).Error; err != nil {
		return err
	}
