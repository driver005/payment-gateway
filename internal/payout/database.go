...
func (s *Handler) Retrive(ctx context.Context, Id uuid.UUID) (*Payout, error) {
	var m Payout
...
func (s *Handler) List(ctx context.Context, Offset int, Size int) ([]Payout, *int64, error) {
	var m = make([]Payout, 0)
...
func (s *Handler) Create(ctx context.Context, m *Payout) (*Payout, error) {
...
func (s *Handler) Update(ctx context.Context, m *Payout) (*Payout, error) {
	var o *Payout
...
func (r *Handler) Upsert(ctx context.Context, m *Payout) (*Payout, error) {
...
func (s *Handler) Delete(ctx context.Context, Id uuid.UUID) error {
	if err := s.r.Manager(ctx).Where("id = ?", Id).Delete(&Payout{}).Error; err != nil {
		return err
	}
