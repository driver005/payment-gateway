...
func (s *Handler) Retrive(ctx context.Context, Id uuid.UUID) (*Charge, error) {
	var m Charge
...
func (s *Handler) List(ctx context.Context, Offset int, Size int) ([]Charge, *int64, error) {
	var m = make([]Charge, 0)
...
func (s *Handler) Create(ctx context.Context, m *Charge) (*Charge, error) {
...
func (s *Handler) Update(ctx context.Context, m *Charge) (*Charge, error) {
	var o *Charge
...
func (r *Handler) Upsert(ctx context.Context, m *Charge) (*Charge, error) {
...
func (s *Handler) Delete(ctx context.Context, Id uuid.UUID) error {
	if err := s.r.Manager(ctx).Where("id = ?", Id).Delete(&Charge{}).Error; err != nil {
		return err
	}
