...
type PaymentIntentNextActionDisplayBankTransferInstructions struct {
	...
	FinancialAddresses []fundingInstruction.FundingInstructionsBankTransferFinancialAddress `json:"financial_addresses,omitempty" database:"foreignKey:id" swaggertype:"array,string" format:"uuid"`
