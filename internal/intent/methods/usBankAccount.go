...
type PaymentIntentPaymentMethodOptionsUsBankAccount struct {
	...
	FinancialConnections *LinkedAccountOptionsUsBankAccount `json:"financial_connections,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
