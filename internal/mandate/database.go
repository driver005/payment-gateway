...
func (s *Handler) Retrive(ctx context.Context, Id uuid.UUID) (*Mandate, error) {
	var m Mandate
...
func (s *Handler) List(ctx context.Context, Offset int, Size int) ([]Mandate, *int64, error) {
...
func (s *Handler) Create(ctx context.Context, m *Mandate) (*Mandate, error) {
...
func (s *Handler) Update(ctx context.Context, m *Mandate) (*Mandate, error) {
	var o *Mandate
...
func (r *Handler) Upsert(ctx context.Context, m *Mandate) (*Mandate, error) {
...
func (s *Handler) Delete(ctx context.Context, Id uuid.UUID) error {
	if err := s.r.Manager(ctx).Where("id = ?", Id).Delete(&Mandate{}).Error; err != nil {
		return err
	}
