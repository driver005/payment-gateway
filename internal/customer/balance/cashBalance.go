...
type CustomerCashBalanceTransaction struct {
	AppliedToPayment *intent.PaymentIntent `json:"applied_to_payment,omitempty" database:"foreignKey:id"`
	...
	Funded        *BankTransfer `json:"funded,omitempty" database:"foreignKey:id"`
	...
	Type                 string                `json:"type,omitempty"`
	UnappliedFromPayment *intent.PaymentIntent `json:"unapplied_from_payment,omitempty" database:"foreignKey:id"`
}
