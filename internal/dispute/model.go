...
type Dispute struct {
	...
	BalanceTransactions []balance.BalanceTransaction `json:"balance_transactions,omitempty" database:"foreignKey:id" swaggertype:"array,string" format:"uuid"`
	// Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
	Currency        string                  `json:"currency,omitempty"`
	Evidence        *DisputeEvidence        `json:"evidence,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	EvidenceDetails *DisputeEvidenceDetails `json:"evidence_details,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
...
type DisputeEvidence struct {
	...
	CancellationPolicy *file.File `json:"cancellation_policy,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	CustomerCommunication *file.File `json:"customer_communication,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	CustomerSignature            *file.File `json:"customer_signature,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	DuplicateChargeDocumentation *file.File `json:"duplicate_charge_documentation,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	Receipt            *file.File `json:"receipt,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	RefundPolicy       *file.File `json:"refund_policy,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	ServiceDocumentation *file.File `json:"service_documentation,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	...
	ShippingDocumentation *file.File `json:"shipping_documentation,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
	// The tracking number for a physical product, obtained from the delivery service. If multiple tracking numbers were generated for this purchase, please separate them with commas.
	ShippingTrackingNumber string     `json:"shipping_tracking_number,omitempty"`
	UncategorizedFile      *file.File `json:"uncategorized_file,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
