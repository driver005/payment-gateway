...
type Dispute struct {
	...
	BalanceTransactions []balance.BalanceTransaction `json:"balance_transactions"`
...
type DisputeEvidence struct {
	...
	CancellationPolicy *file.File  `json:"cancellation_policy,omitempty"`
	...
	CustomerCommunication *file.File  `json:"customer_communication,omitempty"`
	...
	CustomerSignature            *file.File  `json:"customer_signature,omitempty"`
	DuplicateChargeDocumentation *file.File  `json:"duplicate_charge_documentation,omitempty"`
	...
	Receipt            *file.File  `json:"receipt,omitempty"`
	RefundPolicy       *file.File  `json:"refund_policy,omitempty"`
	...
	ServiceDocumentation *file.File  `json:"service_documentation,omitempty"`
	...
	ShippingDocumentation *file.File  `json:"shipping_documentation,omitempty"`
	// The tracking number for a physical product, obtained from the delivery service. If multiple tracking numbers were generated for this purchase, please separate them with commas.
	ShippingTrackingNumber string `json:"shipping_tracking_number,omitempty"`
	UncategorizedFile      *file.File  `json:"uncategorized_file,omitempty"`
