...
func (h *Handler) GetDiscountConditions(ctx context.Context, filters models.Filter, config core.Filter, model models.DiscountCondition) ([]models.DiscountCondition, *int64, error) {
	...
	if m == nil {
		m = []models.DiscountCondition{}
	}

	return m, &n.RowsAffected, nil
}

func (h *Handler) GetDiscountConditionByCode(ctx context.Context, code string) (*models.DiscountCondition, error) {
	var m models.DiscountCondition
...
func (h *Handler) CreateDiscountCondition(ctx context.Context, m *models.DiscountCondition) (*models.DiscountCondition, error) {
...
func (h *Handler) DeleteDiscountCondition(ctx context.Context, id uuid.UUID) error {
	if err := h.r.Manager(ctx).Where("id = ?", id).Delete(&models.DiscountCondition{}).Error; err != nil {
