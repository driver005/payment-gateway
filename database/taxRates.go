...
func (h *Handler) GetTaxRate(ctx context.Context, id uuid.UUID) (*models.TaxRate, error) {
...
func (h *Handler) GetTaxRates(ctx context.Context, filters models.Filter) ([]models.TaxRate, *int64, error) {
	...
	n := h.r.Manager(ctx).Find(&models.TaxRate{})
	if n.Error != nil {
