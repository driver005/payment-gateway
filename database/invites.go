...
func (h *Handler) GetInvite(ctx context.Context, id uuid.UUID) (*models.Invite, error) {
	var m models.Invite
...
func (h *Handler) GetInvites(ctx context.Context, filters models.Filter) ([]models.Invite, *int64, error) {
	...
	n := h.r.Manager(ctx).Find(&models.Invite{})
	if n.Error != nil {
