...
type GetRegionsRegionFulfillmentOptions200Response struct {

	FulfillmentOptions []GetRegionsRegionFulfillmentOptions200ResponseFulfillmentOptionsInner `json:"fulfillment_options,omitempty"`
}
