...
type PostProductsRequestVariantsInner struct {
	...
	Prices []PostProductsRequestVariantsInnerPricesInner `json:"prices,omitempty"`

	Options []PostProductsRequestVariantsInnerOptionsInner `json:"options,omitempty"`
}
