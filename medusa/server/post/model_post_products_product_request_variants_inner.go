...
type PostProductsProductRequestVariantsInner struct {
	...
	Prices []PostProductsProductRequestVariantsInnerPricesInner `json:"prices,omitempty"`

	Options []PostProductsProductRequestVariantsInnerOptionsInner `json:"options,omitempty"`
}
