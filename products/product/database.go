...
func (s *Handler) Retrive(ctx context.Context, Id uuid.UUID) (*Product, error) {
	var m Product
...
func (s *Handler) List(ctx context.Context, Offset int, Size int) ([]Product, *int64, error) {
...
func (s *Handler) Create(ctx context.Context, m *Product) (*Product, error) {
...
func (s *Handler) Update(ctx context.Context, m *Product) (*Product, error) {
	var o *Product
...
func (r *Handler) Upsert(ctx context.Context, m *Product) (*Product, error) {
...
func (s *Handler) Delete(ctx context.Context, Id uuid.UUID) error {
	if err := s.r.Manager(ctx).Where("id = ?", Id).Delete(&Product{}).Error; err != nil {
		return err
	}
