...
type ReturnItem struct {
	...
	Quantity int32 `json:"quantity" database:"default:null"`
	...
	RequestedQuantity int32 `json:"requested_quantity" database:"default:null"`

	// The quantity that was received in the warehouse.
	RecievedQuantity int32 `json:"recieved_quantity" database:"default:null"`
