...
type LineItem struct {
	...
	FulfilledQuantity int32 `json:"fulfilled_quantity" database:"default:null"`

	// The quantity of the Line Item that has been returned.
	ReturnedQuantity int32 `json:"returned_quantity" database:"default:null"`

	// The quantity of the Line Item that has been shipped.
	ShippedQuantity int32 `json:"shipped_quantity" database:"default:null"`

	// The amount that can be refunded from the given Line Item. Takes taxes and discounts into consideration.
	Refundable int32 `json:"refundable" database:"default:null"`
	...
	OriginalTotal int32 `json:"original_total" database:"default:null"`

	// The original tax total amount of the line item
	OriginalTaxTotal int32 `json:"original_tax_total" database:"default:null"`
