...
type BatchJobResult struct {
	Count float32 `json:"count,omitempty" database:"default:null"`

	AdvancementCount float32 `json:"advancement_count,omitempty" database:"default:null"`

	Progress float32 `json:"progress,omitempty" database:"default:null"`
	...
	FileSize float32 `json:"file_size,omitempty" database:"default:null"`
}
