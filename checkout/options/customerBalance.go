...
type CheckoutCustomerBalancePaymentMethodOptions struct {
	...
	BankTransfer *CheckoutCustomerBalanceBankTransferPaymentMethodOptions `json:"bank_transfer,omitempty" database:"foreignKey:id" swaggertype:"primitive,string" format:"uuid"`
