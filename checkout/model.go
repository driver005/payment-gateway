...
type CheckoutSession struct {
	...
	ShippingDetails           *address.Shipping                                          `json:"shipping_details,omitempty"`
	ShippingOptions           []page.PaymentPagesCheckoutSessionShippingOption           `json:"shipping_options,omitempty" database:"foreignKey:id"`
