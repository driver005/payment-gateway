...
type TaxRate struct {
	...
	ProductCount int `json:"product_count" database:"default:null"`

	// The count of product types
	ProductTypeCount int `json:"product_type_count" database:"default:null"`

	// The count of shipping options
	ShippingOptionCount int `json:"shipping_option_count" database:"default:null"`
