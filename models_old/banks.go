...
func (c CreditCard) Validate() error {
	return validation.ValidateStruct(&c,
		...
		validation.Field(&c.Wallet.Masterpass.BillingAddress.City, validation.Length(5, 50)),
		validation.Field(&c.Wallet.Masterpass.BillingAddress.Country, validation.Length(5, 50), is.CountryCode2),
		validation.Field(&c.Wallet.Masterpass.BillingAddress.Line1, validation.Length(5, 50)),
		validation.Field(&c.Wallet.Masterpass.BillingAddress.Line2, validation.Length(5, 50)),
		validation.Field(&c.Wallet.Masterpass.BillingAddress.State, validation.Match(regexp.MustCompile("^[A-Z]{2}$"))),
		validation.Field(&c.Wallet.Masterpass.BillingAddress.Zip, validation.Match(regexp.MustCompile("^[0-9]{5}$"))),
		validation.Field(&c.Wallet.Masterpass.ShippingAddress.City, validation.Length(5, 50)),
		validation.Field(&c.Wallet.Masterpass.ShippingAddress.Country, validation.Length(5, 50), is.CountryCode2),
		validation.Field(&c.Wallet.Masterpass.ShippingAddress.Line1, validation.Length(5, 50)),
		validation.Field(&c.Wallet.Masterpass.ShippingAddress.Line2, validation.Length(5, 50)),
		validation.Field(&c.Wallet.Masterpass.ShippingAddress.State, validation.Match(regexp.MustCompile("^[A-Z]{2}$"))),
		validation.Field(&c.Wallet.Masterpass.ShippingAddress.Zip, validation.Match(regexp.MustCompile("^[0-9]{5}$"))),
		validation.Field(&c.Wallet.Masterpass.Email, is.Email),
		validation.Field(&c.Wallet.Masterpass.Name),
		validation.Field(&c.Wallet.VisaCheckout.BillingAddress.City, validation.Length(5, 50)),
		validation.Field(&c.Wallet.VisaCheckout.BillingAddress.Country, validation.Length(5, 50), is.CountryCode2),
		validation.Field(&c.Wallet.VisaCheckout.BillingAddress.Line1, validation.Length(5, 50)),
		validation.Field(&c.Wallet.VisaCheckout.BillingAddress.Line2, validation.Length(5, 50)),
		validation.Field(&c.Wallet.VisaCheckout.BillingAddress.State, validation.Match(regexp.MustCompile("^[A-Z]{2}$"))),
		validation.Field(&c.Wallet.VisaCheckout.BillingAddress.Zip, validation.Match(regexp.MustCompile("^[0-9]{5}$"))),
		validation.Field(&c.Wallet.VisaCheckout.ShippingAddress.City, validation.Length(5, 50)),
		validation.Field(&c.Wallet.VisaCheckout.ShippingAddress.Country, validation.Length(5, 50), is.CountryCode2),
		validation.Field(&c.Wallet.VisaCheckout.ShippingAddress.Line1, validation.Length(5, 50)),
		validation.Field(&c.Wallet.VisaCheckout.ShippingAddress.Line2, validation.Length(5, 50)),
		validation.Field(&c.Wallet.VisaCheckout.ShippingAddress.State, validation.Match(regexp.MustCompile("^[A-Z]{2}$"))),
		validation.Field(&c.Wallet.VisaCheckout.ShippingAddress.Zip, validation.Match(regexp.MustCompile("^[0-9]{5}$"))),
